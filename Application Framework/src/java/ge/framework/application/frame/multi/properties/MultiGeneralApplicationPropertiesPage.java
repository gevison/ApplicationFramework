package ge.framework.application.frame.multi.properties;
 ...
 * Time: 18:34
 */
public class MultiGeneralApplicationPropertiesPage extends PropertiesDialogPage<MultiFrameApplicationConfiguration>
        implements
        ActionListener,
        ChangeListener
{
    ...
    @Override
    public void setCurrentValues( MultiFrameApplicationConfiguration applicationConfiguration )
    {
    ...
    @Override
    public void updateProperties( MultiFrameApplicationConfiguration applicationConfiguration )
    {
