 ...
 */
public class CloseOthersDocumentMenuItem extends ApplicationFrameMenuItem
{
    private static Resources resources = Resources.getInstance( "ge.framework.frame.core" );

    public CloseOthersDocumentMenuItem( ApplicationFrame applicationFrame )
    {
    ...
    {
        applicationFrame.closeAllDocumentExceptCurrent();
    }
