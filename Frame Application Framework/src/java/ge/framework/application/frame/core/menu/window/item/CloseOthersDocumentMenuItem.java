 ...
 */
public class CloseOthersDocumentMenuItem extends DocumentWorkspaceApplicationFrameMenuItem
{
    private static Resources resources = Resources.getInstance( "ge.framework.frame.core" );

    public CloseOthersDocumentMenuItem( DocumentWorkspaceApplicationFrame applicationFrame )
    {
    ...
    {
        setText( resources.getResourceString( CloseOthersDocumentMenuItem.class, "label" ) );
    }
    ...
    public void actionPerformed( ActionEvent actionEvent )
    {
        ...
        documentWorkspaceApplicationFrame.closeAllDocumentExceptCurrent();
    }
