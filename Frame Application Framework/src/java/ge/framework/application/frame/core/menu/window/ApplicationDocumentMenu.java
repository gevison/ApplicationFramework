...
import ge.framework.application.frame.core.menu.window.item.ApplicationDocumentMenuItem;
import ge.framework.application.frame.core.menu.window.item.OtherDocumentMenuItem;
