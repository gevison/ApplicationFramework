...
import ge.framework.application.frame.core.menu.view.item.ApplicationDockableFrameMenuItem;
import ge.framework.application.frame.core.menu.view.item.OtherDockableFramesMenuItem;
